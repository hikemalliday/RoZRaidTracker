// TODO: DEFUNCT - We are now using a singleton axios instance, and AuthContext mutates this instance with request interceptors via useEffect. All request hooks now use said 'api' instance.
